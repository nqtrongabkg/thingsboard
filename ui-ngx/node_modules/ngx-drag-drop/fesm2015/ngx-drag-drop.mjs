...
function setDragData(event, data, effectAllowed) {
    ...
    try {
        (_a = event.dataTransfer) === null || _a === void 0 ? void 0 : _a.setData(mimeType, dataString);
    }
    catch (e) {
        //   Setting a custom MIME type did not work, we are probably in IE or Edge.
        try {
            (_b = event.dataTransfer) === null || _b === void 0 ? void 0 : _b.setData(JSON_MIME_TYPE, dataString);
        }
        catch (e) {
            ...
            (_c = event.dataTransfer) === null || _c === void 0 ? void 0 : _c.setData(MSIE_MIME_TYPE, dataString);
        }
    }
}
function getDropData(event, dragIsExternal) {
    ...
    if (dragIsExternal === true) {
        if (mimeType !== null && mimeTypeIsCustom(mimeType)) {
            ...
            return JSON.parse((_b = (_a = event.dataTransfer) === null || _a === void 0 ? void 0 : _a.getData(mimeType)) !== null && _b !== void 0 ? _b : '{}');
        }
    ...
    if (mimeType !== null) {
        // the type of content is well known and safe to handle
        return JSON.parse((_d = (_c = event.dataTransfer) === null || _c === void 0 ? void 0 : _c.getData(mimeType)) !== null && _d !== void 0 ? _d : '{}');
    }
    // the contained data is unknown, let user handle it
    return {};
}
