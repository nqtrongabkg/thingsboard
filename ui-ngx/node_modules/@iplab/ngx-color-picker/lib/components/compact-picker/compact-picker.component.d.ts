...
export declare class CompactPickerComponent implements OnInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CompactPickerComponent, "compact-picker", never, { "color": "color"; "control": "control"; }, { "colorChange": "colorChange"; }, never, ["[before]", "*"], false, never>;
}
