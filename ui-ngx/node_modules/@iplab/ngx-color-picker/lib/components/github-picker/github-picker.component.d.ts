...
export declare class GithubPickerComponent implements OnInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<GithubPickerComponent, "github-picker", never, { "color": "color"; "control": "control"; "columns": "columns"; }, { "colorChange": "colorChange"; }, never, ["[before]", "*"], false, never>;
}
