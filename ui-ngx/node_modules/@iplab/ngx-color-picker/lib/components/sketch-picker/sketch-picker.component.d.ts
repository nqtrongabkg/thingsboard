...
export declare class SketchPickerComponent implements OnInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<SketchPickerComponent, "sketch-picker", never, { "color": "color"; "control": "control"; }, { "colorChange": "colorChange"; }, never, ["[before]", "*"], false, never>;
}
