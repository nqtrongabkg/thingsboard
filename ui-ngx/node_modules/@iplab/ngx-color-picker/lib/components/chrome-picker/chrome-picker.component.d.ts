...
export declare class ChromePickerComponent implements OnInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ChromePickerComponent, "chrome-picker", never, { "color": "color"; "control": "control"; }, { "colorChange": "colorChange"; }, never, ["[before]", "*"], false, never>;
}
