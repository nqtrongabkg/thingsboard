...
ColorPresetComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ColorPresetComponent, deps: [{ token: i1.ColorPickerConfig }, { token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Component });
