...
class GridsterRenderer {
    ...
    getGridColumnStyle(i) {
        ...
        newPos.style = Object.assign(Object.assign({}, this.getLeftPosition(newPos.left)), { width: newPos.width + 'px', height: newPos.height + 'px' });
    ...
    getGridRowStyle(i) {
        ...
        newPos.style = Object.assign(Object.assign({}, this.getTopPosition(newPos.top)), { width: newPos.width + 'px', height: newPos.height + 'px' });
        // use the last cached style if it has same values as the generated one
                ...
                if (directions.includes(Direction.UP) &&
                    this.gridsterItem.el.getBoundingClientRect().top <
                        this.gridster.el.getBoundingClientRect().top +
                            ((_a = this.outerMarginTop) !== null && _a !== void 0 ? _a : this.margin)) {
                ...
                if (directions.includes(Direction.LEFT) &&
                    this.gridsterItem.el.getBoundingClientRect().left <
                        this.gridster.el.getBoundingClientRect().left +
                            ((_b = this.outerMarginLeft) !== null && _b !== void 0 ? _b : this.margin)) {
                ...
                if (directions.includes(Direction.RIGHT) &&
                    this.gridsterItem.el.getBoundingClientRect().right >
                        this.gridster.el.getBoundingClientRect().right -
                            ((_c = this.outerMarginRight) !== null && _c !== void 0 ? _c : this.margin)) {
                ...
                if (directions.includes(Direction.DOWN) &&
                    this.gridsterItem.el.getBoundingClientRect().bottom >
                        this.gridster.el.getBoundingClientRect().bottom -
                            ((_d = this.outerMarginBottom) !== null && _d !== void 0 ? _d : this.margin)) {
...
class GridsterResizable {
    constructor(gridsterItem, gridster, zone) {
        ...
        this.handleSouth = (e) => {
            ...
            if (this.gridster.options.enableBoundaryControl) {
                const margin = (_a = this.outerMarginBottom) !== null && _a !== void 0 ? _a : this.margin;
        ...
        this.handleEast = (e) => {
            ...
            if (this.gridster.options.enableBoundaryControl) {
                const margin = (_a = this.outerMarginRight) !== null && _a !== void 0 ? _a : this.margin;
                const box = this.gridster.el.getBoundingClientRect();
...
GridsterItemComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.3", ngImport: i0, type: GridsterItemComponent, deps: [{ token: ElementRef }, { token: GridsterComponent }, { token: Renderer2 }, { token: NgZone }], target: i0.ɵɵFactoryTarget.Component });
...
GridsterModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.3", ngImport: i0, type: GridsterModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
GridsterModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.2.3", ngImport: i0, type: GridsterModule, imports: [GridsterComponent, GridsterItemComponent], exports: [GridsterComponent, GridsterItemComponent] });
GridsterModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.2.3", ngImport: i0, type: GridsterModule, imports: [GridsterComponent, GridsterItemComponent] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.3", ngImport: i0, type: GridsterModule, decorators: [{
            type: NgModule,
            args: [{
